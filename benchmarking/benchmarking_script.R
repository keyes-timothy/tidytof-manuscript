...
benchmark_master <-
  function(
    ...
    if (run_io) {
      ...
      io_benchmarking %>%
        write_rds(file = here::here("benchmarking", file_name))

      io_benchmarking_csv %>%
        write_rds(file = here::here("benchmarking", file_name_csv))
      }
    ...
    if (run_tsne) {
      ...
      # save benchmarking output as an .rds
      tsne_benchmark %>%
        write_rds(file = here::here("benchmarking", file_name_tsne))
    ...
    if (run_pca) {
      ...
      pca_benchmark %>%
        write_rds(file = here::here("benchmarking", file_name_pca))
    }
    ...
    if (run_umap) {
      ...
      # save benchmarking output as an .rds
      umap_benchmark %>%
        write_rds(file = here::here("benchmarking", file_name_umap))
    ...
    if (run_memory) {
      ...
      memory_tibble %>%
        write_rds(file = here::here("benchmarking", "memory.rds"))
    }
    ...
    if (run_style) {
      ...
      code_tibble %>%
        write_rds(file = here::here("benchmarking", "code_style.rds"))
    }
